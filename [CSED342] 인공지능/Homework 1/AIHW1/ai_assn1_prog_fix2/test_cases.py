dfs_basic_test = [
    ...
    },
    {
        ...
        'end_node_id': 9,
        # Expected output:
        'route': [[0, 1, 3, 5, 6, 7, 9], [0, 2, 4, 5, 6, 8, 9]],
        'total_time': 6,
        'node_access_count_threshold': 6
    },
    {
        ...
        'end_node_id': 10,
        # Expected output:
        # 'route': [[0, 1, 3, 4, 5, 6, 7, 8, 9, 10]],
        # 'total_time': 9,
        'node_access_count_threshold': 6,
        # Expected output when reversed:
        'route': [[0, 2, 10]],
        'total_time': 2,
    },
    {
...
astar_basic_test = [
    ...
    #     'dict_graph': {
    #         0: {1: 1.0, 2: 1.0, 'coord': (0, 0)},
    #         1: {0: 1.0, 3: 1, 4: 1.0, 'coord': (1, 0)},
    #         2: {0: 1.0, 3: 1.0, 'coord': (0, 1)},
    #         3: {1: 1, 2: 1.0, 'coord': (1, 1)},
    #         4: {1: 1.0, 'coord': (2, 0)},
    #     },
    #     'start_node_id': 0,
    #     'end_node_id': 3,
